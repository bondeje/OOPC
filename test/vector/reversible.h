 ...
 # define OOP_MEMBERS_G_Reversible MEMBER_TYPE, (Reversible_CLASS * class__;, Reversible_CLASS *, class__, (OOP_NO_DEFAULT), sizeof(Reversible_CLASS *)) ) FUNCTION_TYPE, (int ( * reverse ) ( void * );, ftype_reverse_14, reverse, (NULL), sizeof(void*), typedef int ( * ftype_reverse_14 ) ( void * );) ) FUNCTION_TYPE, (int ( * reversed ) ( void *, void * );, ftype_reversed_15, reversed, (NULL), sizeof(void*), typedef int ( * ftype_reversed_15 ) ( void *, void * );) ) PARENT_TYPE, (Iterable Iterable__;, Iterable, Iterable__, (OOP_NO_DEFAULT), sizeof(Iterable)) ) 
