 ...
 # define OOP_MEMBERS_G_Creatable MEMBER_TYPE, (Creatable_CLASS * class__;, Creatable_CLASS *, class__, (OOP_NO_DEFAULT), sizeof(Creatable_CLASS *)) ) FUNCTION_TYPE, (void * ( * new ) ( unsigned int, ... );, ftype_new_33, new, (NULL), sizeof(void*), typedef void * ( * ftype_new_33 ) ( unsigned int, ... );) ) FUNCTION_TYPE, (int ( * del ) ( void * );, ftype_del_34, del, (NULL), sizeof(void*), typedef int ( * ftype_del_34 ) ( void * );) ) 
