...
build_classes: build_initializable build_creatable build_sized build_container build_iteration build_collection build_reversible build_sequence build_slice build_array build_array_c build_vector
...
pp_vector:
	$(CC) $(PRE_CFLAGS) $(PRE_IFLAGS) ../../templates/vector.def.h -o $(current_dir)/vector.h

build_vector: pp_vector
	$(CLEAN_SCRIPT) $(current_dir)/vector.h
...
clean:
	$(DEL_FILE) foobar.h collection.h sized.h container.h creatable.h initializable.h iteration.h reversible.h sequence.h array.h slice.h vector.h log.txt